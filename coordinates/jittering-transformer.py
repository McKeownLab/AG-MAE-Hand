...
# -------------------------------
# Augmentation: Jittering Function
# -------------------------------
...
input_dim       = 3 * 21       # Raw frame feature dimension (3 x 21 = 63)
...
class VideoDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Flatten each frame: (max_frames, 3, 21) -> (max_frames, 63)
...
# Use augmented training set, while validation and test sets remain unchanged.
...
# -------------------------------
# 5. Model Building: Transformer-Based Classifier
# -------------------------------
...
# -------------------------------
# 9. Confusion Matrix for Test Set and Plotting
# -------------------------------
