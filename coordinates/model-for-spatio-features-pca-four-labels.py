...
# Extract the labels and keep the original 0, 1, 2, 3 labels
...
# Plot for label 1 (class 1)
plt.scatter(reduced_coordinates[labels == 1, 0], reduced_coordinates[labels == 1, 1], label='Class 1', color='red', alpha=0.6)

# Plot for label 2 (class 2)
plt.scatter(reduced_coordinates[labels == 2, 0], reduced_coordinates[labels == 2, 1], label='Class 2', color='green', alpha=0.6)

# Plot for label 3 (class 3)
plt.scatter(reduced_coordinates[labels == 3, 0], reduced_coordinates[labels == 3, 1], label='Class 3', color='purple', alpha=0.6)

# Add labels and title
plt.xlabel('Principal Component 1')
plt.ylabel('Principal Component 2')
plt.title('PCA of Hand Joint Coordinates (Classes 0, 1, 2, 3)')
plt.legend()
plt.grid(True)
plt.show()
