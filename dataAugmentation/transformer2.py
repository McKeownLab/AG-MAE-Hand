...
data = pd.read_csv("final_data/complete_embeddings.csv")
...
class TransformerClassifier(nn.Module):
    def __init__(self, d_model=48, nhead=4, num_layers=3, ff_dim=128, dropout=0.2, seq_length=400):
        ...
        self.fc3 = nn.Linear(64, 1)   # Output layer (logit for binary classification)
        self.relu = nn.ReLU()
...
# Use pos_weight to balance the loss (adjust if needed)
